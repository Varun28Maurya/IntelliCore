...
export default function DataScientistSidebar() {
  const navItems = [
  { name: "Overview", path: "/datascientist", icon: BarChart2 },
  { name: "Model Performance", path: "/datascientist/performance", icon: TrendingUp },
  { name: "Drift Monitoring", path: "/datascientist/drift", icon: Activity },
  { name: "Bias & Fairness", path: "/datascientist/bias", icon: Scale },
  { name: "Model Registry", path: "/datascientist/registry", icon: Database },
  { name: "Experiments", path: "/datascientist/experiments", icon: FlaskConical },
  { name: "Alerts", path: "/datascientist/alerts", icon: AlertCircle },
];


  const systemStatus = {
    label: "Models Performing Normally",
      ...
      <div className="px-6 pb-8">
        <div className="border-t border-slate-200 mt-6 pt-5">
          <p className="text-[11px] font-bold text-slate-900 uppercase tracking-widest">
            Intellicore Data Science
          </p>
          <p className="text-[10px] text-slate-400 font-medium">
            Model Monitoring Suite • v2.8.4
          </p>
