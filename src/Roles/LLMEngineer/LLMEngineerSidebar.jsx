...
export default function LLMSidebar() {
  const navItems = [
  { name: "LLM Overview", path: "/llm", icon: Cpu },
  { name: "Performance Metrics", path: "/llm/performance", icon: Clock },
  { name: "Token Usage & Cost", path: "/llm/cost", icon: Coins },
  { name: "Safety Monitoring", path: "/llm/safety", icon: Shield },
  { name: "Prompt Traces", path: "/llm/prompts", icon: FileCode },
  { name: "Red Team Testing", path: "/llm/redteam", icon: AlertOctagon },
  { name: "Alerts", path: "/llm/alerts", icon: AlertCircle },
];


  const systemStatus = {
    label: "LLM Runtime Healthy",
